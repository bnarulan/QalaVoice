...
let PostsController = class PostsController {
    ...
    create(dto, req) {
        return this.posts.create(req.user.userId, dto.content, dto.address, dto.lat, dto.lng, dto.type || 'COMPLAINT', dto.sphere || 'general');
    }
    uploadPhoto(id, file) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PostsController.prototype, "uploadPhoto", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PostsController.prototype, "accept", null);
__decorate([
